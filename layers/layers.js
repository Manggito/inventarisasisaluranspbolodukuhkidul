...
lyr_GoogleSatelliteHybrid_0.setVisible(false);lyr_GoogleSatellite_1.setVisible(true);lyr_GoogleRoads_2.setVisible(false);lyr_OpenTopoMap_3.setVisible(false);lyr_Sungai_4.setVisible(true);lyr_Jalan_5.setVisible(true);lyr_LuasFungsional_6.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_7.setVisible(true);lyr_JENIS_SALURAN_8.setVisible(true);lyr_AREANOMENKLATUR_9.setVisible(true);lyr_BANGUNANNOMENKLATUR_10.setVisible(true);lyr_Tikungan_11.setVisible(true);lyr_Gorong__Gorong_12.setVisible(true);lyr_Titik_Per_50_m_13.setVisible(true);lyr_Bangunan_Air_14.setVisible(true);lyr_Bangunan_Bagi_15.setVisible(true);lyr_Bangunan_Sadap_16.setVisible(true);lyr_Rumah_Pompa_17.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_GoogleSatellite_1,lyr_GoogleRoads_2,lyr_OpenTopoMap_3,lyr_Sungai_4,lyr_Jalan_5,lyr_LuasFungsional_6,lyr_KETERANGAN_KERUSAKAN_SALURAN_7,lyr_JENIS_SALURAN_8,group_SKEMANOMENKLATUR,group_TITIKKETERANGAN,group_TITIKAKSESORIS];
...
lyr_LuasFungsional_6.set('fieldAliases', {'Id': 'Id', 'AREA': 'AREA', 'LUAS': 'LUAS', });
...
lyr_LuasFungsional_6.set('fieldImages', {'Id': 'Range', 'AREA': '', 'LUAS': 'TextEdit', });
...
lyr_LuasFungsional_6.set('fieldLabels', {'Id': 'hidden field', 'AREA': 'hidden field', 'LUAS': 'inline label - visible with data', });
